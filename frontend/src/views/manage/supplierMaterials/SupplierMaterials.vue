...
import moduleAdd from './SupplierMaterialsAdd.vue'
import moduleEdit from './SupplierMaterialsEdit.vue'
import moduleView from './SupplierMaterialsView.vue'
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case '0':
              return <a-tag color="red">不可供</a-tag>
            case '1':
              return <a-tag color="green">可供</a-tag>
            default:
              return '- -'
          }
        }
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/supplier-materials-info/' + ids).then(() => {
